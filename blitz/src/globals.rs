...
global!(QUEUES,              Queues,              queues,              queues_mut,              init_queues);
global!(COMMANDS,            Commands,            commands,            commands_mut,            init_commands);
...
global!(PIPELINES,           Pipelines,           pipelines,           pipelines_mut,           init_pipelines);